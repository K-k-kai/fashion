...
import static Helpers.Constants.CONNECT_TIMEOUT;
import static Helpers.Constants.READ_TIMEOUT;
import static Helpers.Constants.WRITE_TIMEOUT;
...
public class DarajaApiClient {
    ...
    public Service.STKPushService mpesaService() {
        return getRestAdapter().create(Service.STKPushService.class);
    }
}